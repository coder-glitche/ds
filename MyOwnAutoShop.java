...
class Ford extends Car {
    ...
    Ford(int s, double price, String c, int m, int yea) {
        super(s, price, c);
        year=yea;
...
public class MyOwnAutoShop {
    public static void main(String[] args) {
        ...
        Ford f = new Ford(120, 2200000, "Yellow", 120000,1459);
        System.out.println("Price of ford is " + f.getSalePrice()+ "year of manufacture is "+f.year);
